...
?>
    ...
    Post Title:
    <input type="text" value="<?php echo $postTitle; ?>" name="post_title" class="form-control" aria-describedby="emailHelp" placeholder="Post Title"><br>
    Post Content:
    <textarea class="form-control"  name="post_content" id="exampleFormControlTextarea1" rows="9"><?php echo $postContent; ?></textarea><br>
    ...
    Post Keywords:
    <input type="text" name="post_keywords" value="<?php echo $postKeywords; ?>" class="form-control" aria-describedby="emailHelp" placeholder="Post keyword"><br>
